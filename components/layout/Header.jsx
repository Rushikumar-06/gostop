      ...
      <div className="container mx-auto px-6 py-3 flex justify-between items-center">
        <div className="flex items-center justify-between w-full md:w-auto space-x-8">
          ...
          <nav className="hidden  md:flex justify-between w-full space-x-6 text-sm font-medium text-gray-600">
            <a href="#" className=" flex items-center">Destinations <ChevronDown size={16} className="ml-1" /></a>
            <a href="#" className="">Workation</a>
            <a href="#" className="">Coliving</a>
            <a href="#" className="flex items-center">goSTOPS for Business <ChevronDown size={16} className="ml-1" /></a>
            <a href="#" className=" flex items-center">Collaborate with Us <ChevronDown size={16} className="ml-1" /></a>
          </nav>
        </div>
